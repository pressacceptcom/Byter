...
# PressAccept_Byter_Hexadecimal is behaving as expected given a variety of
# inputs.
#
...
var INT_RANDOM_SEED : int = hash('PressAccept_Byter_Hexadecimal')

# number of times to iterate each test
var INT_NUM_TESTS   : int = TestUtilities.INT_NUM_TESTS


func _pad_binary_to_hexadecimal(
		int_value: PressAccept_Arbiter_Basic) -> String:

	if int_value.negative_bool:
		return Binary.pad_to_byte_signed(int_value.to_binary().lstrip('0'), 4)
	else:
		return Binary.pad_to_byte(int_value.to_binary().lstrip('0'), 4)
...
func test_str2binary() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var int_value_bin_str: String = \
			_pad_binary_to_hexadecimal(int_value).lstrip('0')
		var int_value_hex_str: String = \
			int_value.to_signed_hexadecimal().lstrip('0')

		var test_binary_str: String = Hex.str2binary(int_value_hex_str, true)
		...
		int_value_bin_str = _pad_binary_to_hexadecimal(int_value).lstrip('0')
		int_value_hex_str = int_value.to_signed_hexadecimal()

		test_binary_str = Hex.str2binary(int_value_hex_str, true)
...
func test_str2signed() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var int_value_hex_str: String = int_value.to_signed_hexadecimal()

		var test_value     = Hex.str2signed(int_value_hex_str)
		var test_value_obj = Hex.str2signed(int_value_hex_str, false, true)
		...
		test_value = Hex.str2signed(int_value_hex_str, true)
		...
		test_value     = Hex.str2signed(int_value_hex_str)
		test_value_obj = Hex.str2signed(int_value_hex_str, false, true)
...
func test_str2unsigned() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var int_value_decimal: String = int_value.to_decimal()
		var int_value_hex_str: String = int_value.to_hexadecimal()

		var test_value     = Hex.str2unsigned(int_value_hex_str)
		var test_value_obj = Hex.str2unsigned(int_value_hex_str, true)
		...
		int_value.multiply(comparison)
		int_value_decimal = int_value.to_decimal()
		int_value_hex_str = int_value.to_hexadecimal()
		
		test_value     = Hex.str2unsigned(int_value_hex_str)
		test_value_obj = Hex.str2unsigned(int_value_hex_str, true)
...
func test_str2integer() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var test_value     = Hex.str2integer(int_value_hex_str)
		var test_value_obj = Hex.str2integer(int_value_hex_str, true)
		...
		test_value     = Hex.str2integer(int_value_hex_str)
		test_value_obj = Hex.str2integer(int_value_hex_str, true)
...
func test_str2octal() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var int_value_binary  : String = _pad_binary_to_hexadecimal(int_value)
		var int_value_hex_str : String = \
			Binary.str2hexadecimal(int_value_binary)

		var test_str: String = Hex.str2octal(int_value_hex_str)

		assert_eq(test_str, Binary.str2octal(int_value_binary))

		int_value.multiply(comparison)
		int_value_binary  = _pad_binary_to_hexadecimal(int_value)
		int_value_hex_str = Binary.str2hexadecimal(int_value_binary)

		test_str = Hex.str2octal(int_value_hex_str)
...
func test_str2base36() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var int_value_bin_str: String = _pad_binary_to_hexadecimal(int_value)
		var int_value_b36_str: String = Binary.str2base36(int_value_bin_str)
		var int_value_hex_str: String = \
			int_value.to_signed_hexadecimal().lstrip('0')

		var test_str: String = Hex.str2base36(int_value_hex_str)
		...
		if random.randi_range(0, 1) < 1:
			int_value.negative_bool = true
		int_value_bin_str = _pad_binary_to_hexadecimal(int_value)
		int_value_b36_str = Binary.str2base36(int_value_bin_str)
		int_value_hex_str = int_value.to_signed_hexadecimal().lstrip('0')

		test_str = Hex.str2base36(int_value_hex_str)
...
func test_str2base62() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var test_str: String = Hex.str2base62(int_value_hex_str)
		...
		test_str = Hex.str2base62(int_value_hex_str)
...
func test_str2arbitrary() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var test_str: String = Hex.str2arbitrary(int_value_hex_str, _5_func)
		...
		test_str = Hex.str2arbitrary(int_value_hex_str, _43_func)
		...
		int_value_b5_str = Binary.str2arbitrary(int_value_bin_str, _5_func)

		test_str = Hex.str2arbitrary(int_value_hex_str, _5_func)

		assert_eq(test_str, int_value_b5_str)

		int_value_b43_str = Binary.str2arbitrary(int_value_bin_str, _43_func)
...
func test_signed2str() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var test_str: String = Hex.signed2str(comparison)

		assert_eq(test_str, int_value_hex_str)

		int_value.multiply(comparison)
		int_value_hex_str = int_value.to_signed_hexadecimal()

		test_str = Hex.signed2str(int_value.to_decimal())
...
func test_unsigned2str() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var test_str: String = Hex.unsigned2str(comparison).lstrip('0')
		...
		test_str = Hex.unsigned2str(int_value.to_decimal()).lstrip('0')

		assert_eq(test_str, int_value_hex_str)


func test_to_hexadecimal() -> void:
	...
	for _i in range(INT_NUM_TESTS):
		...
		var signed_hex: String = Hex.to_hexadecimal(
			comparison,
			ENUM_RADIX.SIGNED_DECIMAL
		)

		var unsigned_hex: String = Hex.to_hexadecimal(
			int(abs(comparison)),
			ENUM_RADIX.UNSIGNED_DECIMAL
		)

		assert_eq(signed_hex  , Hex.signed2str  (comparison))
		assert_eq(unsigned_hex, Hex.unsigned2str(int(abs(comparison))))

		signed_hex = Hex.to_hexadecimal(
			str(comparison),
			ENUM_RADIX.SIGNED_DECIMAL
		)

		unsigned_hex = Hex.to_hexadecimal(
		...
		var hexadecimal: String = Hex.to_hexadecimal(
			int_value_octal_str,
			ENUM_RADIX.OCTAL
		)

		assert_eq(hexadecimal, Octal.str2hexadecimal(int_value_octal_str))

		var int_value_hex_str = int_value.to_signed_hexadecimal()

		hexadecimal = Hex.to_hexadecimal(
			int_value_hex_str,
			ENUM_RADIX.HEXADECIMAL
		)

		assert_eq(hexadecimal, int_value_hex_str)
		...
		assert_eq(hexadecimal, Binary.array2hexadecimal(int_value_arr))
		...
		assert_eq(signed_hex  , Hex.signed2str  (int_value.to_decimal()))

		int_value.negative_bool = false

		assert_eq(unsigned_hex, Hex.unsigned2str(int_value.to_decimal()))
